...
class DataFrameCountry:
    def __init__(self):
        ...
        self._mal1 = 'https://raw.githubusercontent.com/WarrenHan/' + (
                     'CSE163/master/malaria-death-rates.csv')
        self._mal2 = 'https://raw.githubusercontent.com/WarrenHan/' + (
    ...
    def malaria(self):
        ...
        """
        data1 = pd.read_csv(self._mal1)
        data2 = pd.read_csv(self._mal2)
